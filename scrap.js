...
// const STORIES_PATH = 'topstories';  // https://hacker-news.firebaseio.com/v0/topstories.json
...
//     process.exit(0);
//   } else if (!postsCount) {
//     console.log('--posts is not defined! Use standard value %s', DEFAULT_POSTS_COUNT);
//     postsCount = DEFAULT_POSTS_COUNT;
//   } else if (postsCount > DEFAULT_POSTS_COUNT) {
//     console.log('--posts is larger then %s! Use standard value %s', DEFAULT_POSTS_COUNT, DEFAULT_POSTS_COUNT);
//     postsCount = DEFAULT_POSTS_COUNT;
//   }
// }
//
...
//     let path = getFullPath(STORIES_PATH);
//
